...
if (args.includes('--help') || args.includes('-h')) {
    console.log(`
Usage: fhir-validate-examples [options]
...
Description:
  Validates all example JSON files in the examples/ folder against
  the FHIR specification and configured Implementation Guides.
...
Examples:
  ...
  fhir-validate-examples --version 4.0.1
`);
    process.exit(0);
}
